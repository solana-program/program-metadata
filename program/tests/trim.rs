...
use solana_sdk::{account::AccountSharedData, pubkey::Pubkey, system_program, sysvar};
...
fn test_trim_canonical() {
    ...
    process_instructions(
        ...
        &[
            ...
            (destination_key, AccountSharedData::default()),
            keyed_account_for_system_program(),
            (sysvar::rent::ID, AccountSharedData::from(rent_sysvar())),
        ],
        &[
            Check::success(),
